...
export interface CampaignPlaymasterInterface extends ethers.utils.Interface {
  functions: {
...
export interface CampaignPlaymaster extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CampaignPlaymasterInterface;
